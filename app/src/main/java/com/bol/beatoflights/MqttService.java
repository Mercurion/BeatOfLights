...
public class MqttService extends AppCompatActivity {
...
//When message delivery was complete
    ...
    /**
     * Metodo che legge i parametri di ingresso alla classe, determinando il colore passato
     */
    private void read(){
        Bundle extras = getIntent().getExtras();
        if (extras != null) {
            String value = extras.getString("colore");
            EditText payloadText = (EditText) findViewById(R.id.editText);
            payloadText.setText(value);
        }
    }
