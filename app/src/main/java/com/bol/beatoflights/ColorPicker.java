...
public class ColorPicker extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(attrs,
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker, defStyle, 0);
        final Resources b = getContext().getResources();

        mColorWheelThickness = a.getDimensionPixelSize(
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker_color_wheel_thickness,
                b.getDimensionPixelSize(com.larswerkman.holocolorpicker.R.dimen.color_wheel_thickness));
        mColorWheelRadius = a.getDimensionPixelSize(
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker_color_wheel_radius,
                b.getDimensionPixelSize(com.larswerkman.holocolorpicker.R.dimen.color_wheel_radius));
        mPreferredColorWheelRadius = mColorWheelRadius;
        mColorCenterRadius = a.getDimensionPixelSize(
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker_color_center_radius,
                b.getDimensionPixelSize(com.larswerkman.holocolorpicker.R.dimen.color_center_radius));
        mPreferredColorCenterRadius = mColorCenterRadius;
        mColorCenterHaloRadius = a.getDimensionPixelSize(
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker_color_center_halo_radius,
                b.getDimensionPixelSize(com.larswerkman.holocolorpicker.R.dimen.color_center_halo_radius));
        mPreferredColorCenterHaloRadius = mColorCenterHaloRadius;
        mColorPointerRadius = a.getDimensionPixelSize(
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker_color_pointer_radius,
                b.getDimensionPixelSize(com.larswerkman.holocolorpicker.R.dimen.color_pointer_radius));
        mColorPointerHaloRadius = a.getDimensionPixelSize(
                com.larswerkman.holocolorpicker.R.styleable.ColorPicker_color_pointer_halo_radius,
                b.getDimensionPixelSize(com.larswerkman.holocolorpicker.R.dimen.color_pointer_halo_radius));
